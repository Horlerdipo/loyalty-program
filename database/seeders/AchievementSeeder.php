...
{
    /**
     * @var array<int, array{name: string, type: AchievementType, threshold: float}>
     */
    public static array $salesAchievements = [
     ...
     * @var array<int, array{name: string, type: AchievementType, threshold: float}>
     */
    public static array $priceAchievements = [
    ...
    public function run(): void
    {
        ...
        $achievements = [
            ...self::$priceAchievements,
            ...self::$salesAchievements,
        ];
